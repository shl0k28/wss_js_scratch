...
async function listenForCycle() {
    ...
    let baseUrlCycleAddress = "https://explorer-liberty20.shardeum.org/api/transaction?startCycle=" + cycle + "&endCycle=" + cycle + "&address=0x66c3ca101d1D83bb39CBA20EbF5F4D344Aa7514C" 
